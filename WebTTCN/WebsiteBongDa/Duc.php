...
<div id="content">
	...
	<div class="newscontent">
        ...
        $result = mysqli_query($conn, "SELECT * FROM post  WHERE type LIKE '%Duc%' and duyet = 1 ORDER BY idaccount DESC LIMIT $start, $limit");
        ...
        <div class="paing">
           <?php 
            ...
            if ($current_page > 1 && $total_page > 1){
                echo '<a href="Duc.php?page='.($current_page-1).'">Prev</a> | ';
            }
            ...
            for ($i = 1; $i <= $total_page; $i++){
                if ($i == $current_page){
                    ...
                    echo '<a href="Duc.php?page='.$i.'">'.$i.'</a> | ';
                }
            }
 
            if ($current_page < $total_page && $total_page > 1){
                echo '<a href="Duc.php?page='.($current_page+1).'">Next</a> | ';
            }
           ?>
        </div>			
	</div>
