 ...
 <div id="content">
	...
	<div class="loginborderadduser" style="padding-left: 0%;border: 2px solid white;">
		<?php
			...
			$sql = " UPDATE account SET nickname = '$user', password = '$pass', role = '$role', name = '$name', sex = '$sex', birthday = '$birth', gmail = '$gmail', phone = '$phone', address = '$address' WHERE idaccount = '$id'";
			$rs = mysqli_query($link,$sql);
			echo '<div class="alert alert-success" style="padding-left: 30%;">
    	<strong>Thành công!</strong> cập nhật thông tin account thành công.
  		</div>';
		?>
		<a href="usermanagement.php" style="padding-left: 45%;">Quay lại</a>
	</div>
